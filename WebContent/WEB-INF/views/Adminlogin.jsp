...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  <title>Travel With Me Admin | Login</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Travel With Me</b>Admin Login</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
     ...
     <form:form action="adminLoginSubmit" modelAttribute="adminForm" method="post">
        ...
        <div class="input-group mb-3">
          ...
          <form:input type="text"  id="password" path="password" name="password" class="form-control" placeholder="Password"/>
          <div class="input-group-append">
            <div class="input-group-text">
